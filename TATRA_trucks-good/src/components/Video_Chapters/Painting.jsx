...
import video1_01 from "../../Videos/13 PAINTING/video01.mp4";
import video1_02 from "../../Videos/13 PAINTING/video02.mp4";
import video1_03 from "../../Videos/13 PAINTING/video03.mp4";
import video1_04 from "../../Videos/13 PAINTING/video04.mp4";
import video1_05 from "../../Videos/13 PAINTING/video05.mp4";
      ...
      <div>
        ...
        <div className="card-container">
          <a href={video1_01} target="_blank">
            <Card name="Painting Video-1"></Card>
          </a>
          <a href={video1_02} target="_blank">
            <Card name="Painting Video-2"></Card>
          </a>
          <a href={video1_03} target="_blank">
            <Card name="Painting Video-3"></Card>
          </a>
          <a href={video1_04} target="_blank">
            <Card name="Painting Video-4"></Card>
          </a>
	  <a href={video1_05} target="_blank">
            <Card name="Painting Video-5"></Card>
          </a>
        </div>
      </div>
    </div>
