...
import video1_01 from "../../Videos/10 ENGINE FITMENT/video01.mp4";
import video1_02 from "../../Videos/10 ENGINE FITMENT/video02.mp4";
import video1_03 from "../../Videos/10 ENGINE FITMENT/video03.mp4";
import video1_04 from "../../Videos/10 ENGINE FITMENT/video04.mp4";
    ...
    <div class="bg-custom-primary h-screen bg-cover">
      ...
      <div>
        <p className="text-5xl italic font-semibold text-center text-white underline px-52">
          CHAPTER 10 : Engine Fitment
        </p>
        <div className="card-container">
          <a href={video1_01} target="_blank">
            <Card name="Engine Fitment Video-1"></Card>
          </a>
          <a href={video1_02} target="_blank">
            <Card name="Engine Fitment Video-2"></Card>
          </a>
          <a href={video1_03} target="_blank">
            <Card name="Engine Fitment Video-3"></Card>
          </a>
          <a href={video1_04} target="_blank">
            <Card name="Engine Fitment Video-4"></Card>
          </a>
        </div>
      </div>
    </div>
